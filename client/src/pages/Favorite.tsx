        ...
        <section className="bg-black/70 min-h-screen ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:ml-80 p-10">
                        {favorite.map(product=>{
                            ...
                            return(
                                <article key={product._id} className="bg-[#28282a] group rounded-md flex flex-col items-center py-3 px-10 gap-4 text-white/80 relative border-[1px] border-transparent z-0  hover:border-white/80 transition-color ease-in-out  shadow-md">
